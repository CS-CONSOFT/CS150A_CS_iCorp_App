    ...
    return (
        <>
            <FlatList
                ...
                ListHeaderComponent={<C_003_01_05_TopHeaderItensProdutosDetalhesPV obsContribuinte={pv!.DD075_Obs.at(0)} obsText={pv!.DD070_Nota.csicp_dd070.DD070_Texto} descontoValor={pv?.DD070_Nota.csicp_dd070.DD070_Desconto} isConsulta={true} />}
                renderItem={({ item }) => (
