...
const C_003_01_03_ProductPvItemGarantia = ({ close }: { close: () => void }) => {
    return (
        <View style={[{ flexDirection: 'row', justifyContent: 'space-between' }, common003_02_styles.blueBackgroundColor]}>
            <View style={[commonStyle.rowItem, common003_02_styles.blueBackgroundColor]}>
                <Text style={[commonStyle.fontWeight_600, common003_02_styles.titleItem]}>Garantia</Text>
            </View>
            <View style={[commonStyle.rowItem, common003_02_styles.blueBackgroundColor, { marginRight: 2, justifyContent: 'flex-end' }]}>
